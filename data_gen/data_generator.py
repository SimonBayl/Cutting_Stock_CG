...
def generate_raw_data(num_pieces):
    # return [(random.uniform(5.0, 40.0), random.randint(5, 10)) for _ in range(num_pieces)]
    return [(random.uniform(15, 22.0), random.randint(5, 8)) for _ in range(num_pieces)]
